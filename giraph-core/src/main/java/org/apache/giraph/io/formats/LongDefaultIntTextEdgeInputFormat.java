 ...
 */
public class LongDefaultIntTextEdgeInputFormat extends
  ...
  public EdgeReader<LongWritable, IntWritable> createEdgeReader(
    ...
    return new LongDefaultIntTextEdgeReader();
  }
   ...
   */
  public class LongDefaultIntTextEdgeReader extends
    ...
    @Override
    protected IntWritable getValue(LongPair endpoints) throws IOException {
      // initialize to max value for connected components
